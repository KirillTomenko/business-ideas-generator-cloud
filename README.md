...
**Результат:** [Пример отчета](examples/производство_строительного_бруса_естеств.md)

### Пример 2: EdTech для СНГ
...
**Получите:**
- Анализ 10+ EdTech конкурентов
- Выявление болей студентов и преподавателей
- 5 готовых концепций платформ
- Оценку рисков и конкурентных преимуществ

### Пример 3: Локальный бизнес

**Входные данные:**
```
Ниша: доставка готовой еды
